...
# your task is to define a function xor(a, b) where a and b are the two expressions to be evaluated. Y
# our xor function should have the behaviour described above, returning true if exactly one of the
